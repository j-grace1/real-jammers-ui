  ...
  return (
    <div className='w-full h-[550px] bg-[#df9d39] flex flex-col justify-between'>
        <div className='grid md:grid-cols-2 mx-24 py-32'>
            <div className='flex flex-col justify-center md:items-start py-8' data-aos='fade-up' data-aos-delay='200'>
                ...
                <button className='py-3 mt-12 sm:w-[60%] bg-[#f1ac3c] transition delay-150 hover:bg-[#76def0] border-none'>Get Started</button>
            </div>
